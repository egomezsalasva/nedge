  ...
  return (
    <section>
      ...
      <p>
        ...
        so both Nedge and the stylists can profit and provide you with
        inspiration and discover garments from both up and coming brands as well
        as established brands.
        <br />
        <br />
        <b>So, to all our supporters, thank you for your support.</b>
      </p>
    </section>
  );
};

export default AboutSupportersSection;
